...
SKILLS={
	...
	wudu_qijing={ --ng? ??c k? kinh
		...
		poisonenhance_p={{{1,1},{30,15},{31,15}},{{1,-1},{2,-1}}},
		deadlystrikeenhance_p={{{1,4},{30,45}},{{1,-1},{2,-1}}},
		lifemax_yan_p={{{1,21},{35,20},{36,20}},{{1,-1},{30,-1}}},
		--castspeed_v={{{1,1},{38,20},{39,21}},{{1,-1},{30,-1}}},
		castspeed_v={{{1,1},{40,80}},{{1,-1},{30,-1}}},
		castspeed_yan_v={{{1,32},{40,32}},{{1,-1},{30,-1}}},
		attackspeed_yan_v={{{1,32},{40,32}},{{1,-1},{30,-1}}},
	},
	baidu_chuanxin={ --°Ù¶¾´©ÐÄ
